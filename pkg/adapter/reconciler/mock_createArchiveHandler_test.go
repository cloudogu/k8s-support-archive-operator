...
func (_m *mockCreateArchiveHandler) HandleArchiveRequest(ctx context.Context, cr *v1.SupportArchive) (bool, error) {
...
func (_c *mockCreateArchiveHandler_HandleArchiveRequest_Call) Return(requeue bool, err error) *mockCreateArchiveHandler_HandleArchiveRequest_Call {
	_c.Call.Return(requeue, err)
	return _c
}

func (_c *mockCreateArchiveHandler_HandleArchiveRequest_Call) RunAndReturn(run func(context.Context, *v1.SupportArchive) (bool, error)) *mockCreateArchiveHandler_HandleArchiveRequest_Call {
	_c.Call.Return(run)
	return _c
}
